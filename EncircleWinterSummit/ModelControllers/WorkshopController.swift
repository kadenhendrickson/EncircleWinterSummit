...
//    }
    ...
    static var youthIntroAndOutroWorkshops: [Workshop] {
        let openeingSession = Workshop(name: "Opening Session", title: "Opening Session", time: Date(), description: "(Overflow available in AlphaBravo)", room: "Main Area", map: "opening Map")
        let dinner = Workshop(name: "Dinner", title: "Dinner", time: Date(), description: "The moment you've all been waiting for!", room: "Main Area", map: "opening Map")
        let closingSession = Workshop(name: "Closing Session", title: "Closing Session", time: Date(), description: "(Overflow available in AlphaBravo)", room: "Main Area", map: "opening Map")
    ...
    var  adultWorkhops: [[Workshop]]{
        var adultWorkshop1: [Workshop] {
            let workshop1 = Workshop(name: "Workshop 1", title: "Cultural Identity's Impact on Health", time: sessionOneTime, description: "cultural identity and how it influences the 5 main aspects of personal health, which are emotional, occupational, intellectual, social community environment, physical fitness nutrition, spiritual values ethics.", room: "429", map: "Podium-4")
            let workshop2 = Workshop(name: "Workshop 1", title: "Bearing Your Journey (Without Murmuring)", time: sessionOneTime, description: "The journey of an LGBT Saint in the Church of Jesus Christ of Latter-day Saints can seem like an unending journey in the wilderness. Do we exclaim “It is a hard thing.” or “How is it possible?” and give up? Or do we rejoice in the journey knowing that with God we can bear all trials?", room: "430", map: "Podium-4")
            let workshop3 = Workshop(name: "Workshop 1", title: "Life After Coming Out", time: sessionOneTime, description: "With combined self-love and compassion we will navigate the different obstacles in life after coming out in a safe and open environment. We all have something unique to learn from each other by sharing our stories", room: "421", map: "Podium-4")
            ...
            let workshop9 = Workshop(name: "Workshop 1", title: "What your LGBTQ+ friends and family want you to know about coming out", time: sessionOneTime, description: "Come have a discussion with Matt Easton, the BYU Validictorian who came out in his graduation speech", room: "240", map: "Podium-2")
            let workshop10 = Workshop(name: "Workshop 1", title: "Guardians of Safe Spaces", time: sessionOneTime, description: "", room: "231", map: "Podium-2")
            let workshop11 = Workshop(name: "Workshop 1", title: "Dealing with Coming Out", time: sessionOneTime, description: "Come here more of Ed Smart's story", room: "131", map: "Podium-1")
        ...
        var adultWorkshop2: [Workshop] {
            ...
            let workshop2 = Workshop(name: "Workshop 2", title: "Bearing Your Journey (Without Murmuring)", time: sessionTwoTime, description: "The journey of an LGBT Saint in the Church of Jesus Christ of Latter-day Saints can seem like an unending journey in the wilderness. Do we exclaim “It is a hard thing.” or “How is it possible?” and give up? Or do we rejoice in the journey knowing that with God we can bear all trials?", room: "430", map: "Podium-4")
            let workshop3 = Workshop(name: "Workshop 2", title: "Life After Coming Out", time: sessionTwoTime, description: "With combined self-love and compassion we will navigate the different obstacles in life after coming out in a safe and open environment. We all have something unique to learn from each other by sharing our stories", room: "421", map: "Podium-4")
        ...
        var adultWorkshop3: [Workshop] {
            ...
            let workshop8 = Workshop(name: "Workshop 3", title: "Guardians of Safe Spaces", time: sessionThreeTime, description: "", room: "231", map: "Podium-2")
